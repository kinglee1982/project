...
void vdec_motion_init(void)
{
	...
	int i = 0;
	I2CWriteByte( NVP6114+i, 0xff, 0x03 );
	I2CWriteByte( NVP6114+i, 0x80, 0x40 );
	I2CWriteByte( NVP6114+i, 0x82, 0x40 );
	I2CWriteByte( NVP6114+i, 0x84, 0x40 );
	I2CWriteByte( NVP6114+i, 0x86, 0x40 );
	I2CWriteByte( NVP6114+i, 0x88, 0x40 );
	I2CWriteByte( NVP6114+i, 0x8a, 0x40 );
	I2CWriteByte( NVP6114+i, 0x8c, 0x40 );
	I2CWriteByte( NVP6114+i, 0x8e, 0x40 );

	if((vdec_mode == VDEC_NTSC)||(vdec_mode == VDEC_PAL))
	{	
#ifdef VDEC_108M
		I2CWriteByte( NVP6114+i, 0x81, 0x08 );
		I2CWriteByte( NVP6114+i, 0x83, 0x08 );
		I2CWriteByte( NVP6114+i, 0x85, 0x08 );
		I2CWriteByte( NVP6114+i, 0x87, 0x08 );
		I2CWriteByte( NVP6114+i, 0x89, 0x08 );
		I2CWriteByte( NVP6114+i, 0x8b, 0x08 );
		I2CWriteByte( NVP6114+i, 0x8d, 0x08 );
		I2CWriteByte( NVP6114+i, 0x8f, 0x08 );
#else
		I2CWriteByte( NVP6114+i, 0x81, 0x48 );
		I2CWriteByte( NVP6114+i, 0x83, 0x48 );
		I2CWriteByte( NVP6114+i, 0x85, 0x48 );
		I2CWriteByte( NVP6114+i, 0x87, 0x48 );
		I2CWriteByte( NVP6114+i, 0x89, 0x48 );
		I2CWriteByte( NVP6114+i, 0x8b, 0x48 );
		I2CWriteByte( NVP6114+i, 0x8d, 0x48 );
		I2CWriteByte( NVP6114+i, 0x8f, 0x48 );
#endif
...
void vdec_motion_display(unsigned int ch, unsigned int on)
{
	...
	if(on == 1)
	{
		...
		I2CWriteByte( NVP6114+i, 0xc0, 0x98 );
	}
	else
	{
		I2CWriteByte( NVP6114+i, 0xff, 0x01 );
		I2CWriteByte( NVP6114+i, 0xc0, 0x10 );
	}

	if((vdec_mode == VDEC_NTSC) || (vdec_mode == VDEC_PAL))
	{
		I2CWriteByte( NVP6114+i, 0xff, 0x02 );
		I2CWriteByte( NVP6114+i, 0x12, 0x00 );
	}
	else
	{
		I2CWriteByte( NVP6114+i, 0xff, 0x02 );
		I2CWriteByte( NVP6114+i, 0x12, 0xff );
	}
}
...
void vdec_motion_sensitivity(unsigned int sens[16])
{
	int i = 0;
	I2CWriteByte( NVP6114+i, 0xff, 0x02 );
	I2CWriteByte( NVP6114+i, 0x01, (sens[0]<<4)*2 );
