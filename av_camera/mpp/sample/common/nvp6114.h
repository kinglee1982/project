...
extern int set_brightness(int chn,signed char bright);
extern int set_contrast(int chn,signed char contrast);
extern int set_hue(int chn,signed char hue);
extern int set_saturation(int chn,signed char saturation);
extern int set_video_mode(int chn,int mode);
#endif
