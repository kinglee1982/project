...
/* BEGIN: Deleted by zhangjinlei, 2016/4/21  DES:调试3521A视频VIVO功能   PN:16042001001 */
//#define HDMI_SUPPORT
/* END:   Deleted by zhangjinlei, 2016/4/21   PN:16042001001 */
...
HI_S32 SAMPLE_VIO_8_720P(HI_VOID)
{
	...
	/* BEGIN: Modified by zhangjinlei, 2016/4/20  DES:调试3521A视频VIVO功能   PN:16042001001 */
	VIDEO_NORM_E enNorm = VIDEO_ENCODING_MODE_PAL;
	/* END:   Modified by zhangjinlei, 2016/4/20   PN:16042001001 */
	...
	VPSS_CHN VpssChn_VoSD0 = VPSS_CHN0;
	...
	******************************************/
    ...
    //memcpy(stVbConf.astCommPool[1].acMmzName, "ddr1", strlen("ddr1"));
	...
	******************************************/
    ...
    //SAMPLE_COMM_VI_MemConfig(enViMode);
    //SAMPLE_COMM_VPSS_MemConfig();
...
int main(int argc, char *argv[])
{
    ...
    printf("#[av]av mode test 2016-4-23-16-17!\n");
