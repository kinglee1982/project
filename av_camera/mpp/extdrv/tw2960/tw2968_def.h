...
#if 0
unsigned char tbl_pal_tw2968_common[] = {
	// CH1 CH2 CH3 CH4
...
unsigned char tbl_ntsc_tw2968_common[] = {
	// CH1 CH2 CH3 CH4
	0x00,0x00,0x64,0x11,//.0x00~0x03	0x10~0x13	0x20~0x23	0x30~0x33
...
unsigned char tbl_pal_tw2968_8KHz[] = {
	0xc7,0xB5,0x09,0x00,0xA0,0x00			//...0xF0~0xF5
};
unsigned char tbl_ntsc_tw2968_8KHz[] = {
	0xcf,0xB5,0x09,0x78,0x85,0x00			//...0xF0~0xF5
  };
#else
/*audio*/
unsigned char AudioSetup8K[] = {/*0xf0--0xf5*/
